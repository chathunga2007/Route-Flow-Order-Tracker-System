...
export default function DriverActionModal({ isOpen, onClose, driver, type = 'chat' }) {
  ...
  // Direct injection to document.body to bypass Leaflet map z-index and overflow context
  return createPortal(
    <AnimatePresence>
      <div className="fixed inset-0 z-[999999] bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
        <motion.div
          ...
          className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-md overflow-hidden shadow-2xl text-white relative my-auto flex flex-col"
        >
          {/* Header */}
          ...
          {type === 'call' ? (
              ...
              <div className="flex justify-center gap-4 pt-4">
                {isCalling ? (
                  <button
                    ...
                    className="p-4 bg-red-600 hover:bg-red-500 text-white rounded-full shadow-lg shadow-red-600/30 transition cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="p-4 bg-emerald-600 hover:bg-emerald-500 text-white rounded-full shadow-lg shadow-emerald-600/30 transition cursor-pointer"
                  >
            ...
            /* Live Chat Screen Mode */
            <div className="flex flex-col h-[380px] bg-slate-950/60">
